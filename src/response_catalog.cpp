...
static const Phrase_definition phrase_catalog[] =
{
  ...
  {252, response_act_ask, field_request, department_parts, phrase_variant_retry_question, 1, 9, "Which specific part should the parts team check?"},
  {253, response_act_ask, field_request, department_sales, phrase_variant_retry_question, 1, 9, "Any specific model or type of car?"},
  ...
  {301, response_act_ask, field_callback_time, department_unknown, phrase_variant_confirmation_question, 0, 9, "Is that right?"},
  ...
  {652, response_act_clarify, field_request, department_parts, phrase_variant_any, 1, 9, "I need the specific part the parts team should check."},
  {653, response_act_clarify, field_request, department_sales, phrase_variant_any, 1, 9, "I need the model or type of car the sales team should follow up on."},
  ...
  {1001, response_act_close, field_none, department_unknown, phrase_variant_any, 0, 9, "Perfect, I'll pass this to the {department} team so they can call you back."},
  {1002, response_act_close, field_none, department_unknown, phrase_variant_any, 0, 9, "You're all set. I'll pass this to the {department} team so they can call you back."},
  {1003, response_act_close, field_none, department_unknown, phrase_variant_any, 0, 9, "I'll send this to the {department} team for a callback. Thanks for calling."}
};
